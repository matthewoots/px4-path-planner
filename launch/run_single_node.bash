...
rostopic pub /S0/global_planner_mission std_msgs/Float32MultiArray "layout: 
  dim:
  - label: ''
    size: 0
    stride: 0
...
rostopic pub /S0/global_planner_mission std_msgs/Float32MultiArray "layout: 
  ...
  - label: ''
    ...
    stride: 0
  data_offset: 0
data: [3.0, 3.0, 14.0, 0.0, 1.5, 0.0, 0.0, 0.0, 0.0]" -1 
...
rostopic pub /S0/global_planner_mission std_msgs/Float32MultiArray "layout: 
  ...
  - label: ''
    ...
    stride: 0
  data_offset: 0
data: [3.0, 3.0, 25.0, 0.0, 1.5, 999.0, 999.0, 999.0, 999.0]" -1 
